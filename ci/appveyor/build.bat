...
cmake --version
cmake -DBOOST_ROOT="c:\local\boost_%BOOST_VER_USC%" -DBOOST_LIBRARYDIR="c:\local\boost_%BOOST_VER_USC%\lib%arch%-msvc-14.0" -DCMAKE_BUILD_TYPE=Release %_cmake_per_Arch_Args% ..
