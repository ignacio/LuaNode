...
function test()
	...
	assert_equal(false, net.isIP("x127.0.0.1"))
	assert_equal(false, net.isIP("example.com"))
	assert_equal(true, net.isIP("0000:0000:0000:0000:0000:0000:0000:0000"))
	assert_equal(false, net.isIP("0000:0000:0000:0000:0000:0000:0000:0000::0000"))
	...
	assert_equal(false, net.isIPv4("example.com"))
	assert_equal(false, net.isIPv4("2001:252:0:1::2008:6"))
	
	assert_equal(false, net.isIPv6("127.0.0.1"))
	assert_equal(false, net.isIPv4("example.com"))
